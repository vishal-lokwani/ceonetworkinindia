...
Footer.defaultProps = {
  title: "Ceo Meetup",
  description: "Connect with the minds behind the mission. Discover the CEOs leading innovation, strategy, and success across industries.",
